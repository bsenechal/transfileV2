...
public class Client {
     ...
     * @param merchantFtp
     */
    public Client(final Integer clientId, final String merchantId, final String sipsAlias, final String environment, final String protocol,
            final String bankName, final String merchantFtp) {
        super();
